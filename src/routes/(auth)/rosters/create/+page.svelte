<script lang="ts">
	...
	import { getPlayers } from '../../players/players.remote';
			...
			<Field.Set>
				...
				<section class="flex flex-col items-center justify-center gap-3">
					...
					{:else}
						...
						>
							<p
								class="semi-bold md:text-md flex flex-col items-center gap-1 text-center text-xs text-muted-foreground italic"
							>
