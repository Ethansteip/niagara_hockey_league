    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex flex-col items-center justify-center">
        ...
        <div class="flex flex-col min-w-0">
          <h3 class="font-bold text-sm sm:text-lg lg:text-xl text-foreground truncate">{homeTeamName}</h3>
        </div>
      </div>
      ...
      <div class="flex flex-col items-center justify-center">
        ...
        <div class="flex flex-col min-w-0">
          <h3 class="font-bold text-sm sm:text-lg lg:text-xl text-foreground truncate">{awayTeamName}</h3>
        </div>
      </div>
    </div>
  </CardContent>
