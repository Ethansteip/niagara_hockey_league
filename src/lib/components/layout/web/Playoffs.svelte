<script lang="ts">
 ...
 const standings = [
  ...
  {
    teams: {
      logoUrl: "https://ldvojuueriraazjpzggg.supabase.co/storage/v1/object/public/logos/bruins-logo.png",
      name: "Bruins",
    },
    team_standings: {
      wins: 1,
    ...
    {
    teams: {
      logoUrl: "https://ldvojuueriraazjpzggg.supabase.co/storage/v1/object/public/logos/habs-logo.png",
      name: "Habs",
    },
    team_standings: {
      wins: 0,
