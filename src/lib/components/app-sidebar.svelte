<script lang="ts">
	...
	import ShirtSport from '@tabler/icons-svelte/icons/shirt-sport';
	import ClipboardCheck from '@tabler/icons-svelte/icons/clipboard-check';
			...
			<Sidebar.MenuItem>
				<Sidebar.MenuButton class="data-[slot=sidebar-menu-button]:!p-1.5">
					{#snippet child({ props })}
						<a href="##" {...props}>
							<Bolt class="size-5" />
							<span class="text-base font-semibold">Niagara Hockey league</span>
						</a>
					{/snippet}
				</Sidebar.MenuButton>
			</Sidebar.MenuItem>
